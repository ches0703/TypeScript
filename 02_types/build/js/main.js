...
let anyArray = [1, 2, "3", null, true, [], {}];
// 읽기 전용 배영 생성
// 1. readonly 키워드 사용
let readOnlyArrayKey = [1, 2, 3];
// 2. ReadonlyArray interface 사용
let readOnlyArrayIF = [1, 2, 3];
...
// Union
let union; // 혹은 let code:string|number
union = 123; // OK
union = "hello"; // OK
...
// Null & Undefined
let u = undefined; // -> typeof 사용 시 undefined
let n = null; // -> typeof 사용 시 object
...
let strOrNull = null;
let strOrUndef = undefined;
// void번수 사용 시 : undefined할당 가능
let v;
v = undefined;
// Void
// 반환 값이 없는 함수 -> undefined를 반환
const voidFunc = () => { };
console.log(voidFunc()); // -> undefined 출력
const undefFunc = () => { console.log("hello"); };
undefFunc();
